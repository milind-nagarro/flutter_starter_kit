...
class LivenessCheckProcessor: NSObject, Processor, FaceTecFaceScanProcessorDelegate, URLSessionTaskDelegate {
    ...
    var success = false
    var fromViewController: FacetecBaseViewController
    var faceScanResultCallback: FaceTecFaceScanResultCallback!
    
    init(sessionToken: String, fromViewController: FacetecBaseViewController) {
        ...
        fromViewController.present(livenessCheckViewController, animated: true, completion: {
            print("presented livenesscheckvc")
        })
    }
